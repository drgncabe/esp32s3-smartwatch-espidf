...
Hardware quick reference for developers and AI tools. The content is cross-checked against the official Wiki, schematic V2.1, and the pin definitions in this project.
